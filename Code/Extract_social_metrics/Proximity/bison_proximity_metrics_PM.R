...
load(paste0(data_path,"proximity_data_PM.RData"))
...
save(node_ids, node_degree_all, node_strength_all, density_all, num_iter, edge_thresh, file = "BisonProximity_PM.RData")
