...
for (gy in 1:length(groupyears)){ #for years
  ...
  #Load observed network for group and year
  ...
  # if (groupyears[gy]=="V2018"|groupyears[gy]=="KK2018"){
...
save(node_ids, node_degree_all, node_strength_all,density_all,num_iter,edge_thresh, file = "BisonGrooming.RData")
