...
edgelist.all$rate = edgelist.all$count/edgelist.all$total_samples
edgelist.all$groupyear = as.factor(paste(edgelist.all$group,edgelist.all$year,sep=""))
ggplot(edgelist.all,aes(x=groupyear, y=rate))+
  geom_violin()
