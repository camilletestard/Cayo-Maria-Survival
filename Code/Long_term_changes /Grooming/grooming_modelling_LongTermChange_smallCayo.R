#grooming_modelling_LongTermChange_smallCayo.R
...
#Set group year list
group = c("V","V","V","V","V","V","V")
years = c(2015,2016,2017, 2018,2019,2021,2022)
groupyears = c("V2015","V2016","V2017","V2018","V2019","V2021","V2022")
...
mdl.groomPrePost.SC<-lm( std.dens~ 1+ isPost.year, data=density.all)
summary(mdl.groomPrePost)
#performance::check_model(mdl.groomPrePost)

#Groom strength
mdl.strength.groomPrePost.SC <- with(imp.prepost, lmer(std.groom.strength~ 1+ isPost.year +age+ sex + (1|id)))
summary(mice::pool(mdl.strength.groomPrePost.SC ))
...
#Groom degree
mdl.degree.groomPrePost.SC <- with(imp, lmer(std.groom.degree~ 1+ isPost.year + sex +age+
                                           (1|id)))
summary(mice::pool(mdl.degree.groomPrePost.SC))
...
setwd("~/Documents/GitHub/Cayo-Maria-Survival/Data/R.Data/")
save(mdl.groomPrePost.SC, mdl.strength.groomPrePost.SC, mdl.degree.groomPrePost.SC, file = "GroomMdlOutput_PrePost_smallCayo.RData")
#load( "GroomMdlOutput_PrePost_smallCayo.RData")
