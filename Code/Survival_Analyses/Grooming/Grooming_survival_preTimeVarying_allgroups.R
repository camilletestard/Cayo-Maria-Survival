#Grooming_survival_preTimeVarying_allgroups.R
...
for (i in 1:num_iter){
  ...
  data.final<-data.final[which(data.final$period==1 & data.final$year==2013|
                     data.final$period==2 & data.final$year==2014|
                     data.final$period==3 & data.final$year==2015|
                     data.final$period==4 & data.final$year==2016|
                     data.final$period==5 & data.final$year==2017),]
...
save(strength.groom.pre, degree.groom.pre, file = "GroomMdlOutput_PreHurr_allgroups.RData")
# setwd("~/Documents/GitHub/Cayo-Maria-Survival/Data/R.Data/")
