...
study.end.date = as.Date("2022-08-31")
study.end.date.KK = as.Date("2018-11-01")
...
save(SurvivalData,file ="~/Documents/GitHub/Cayo-Maria-Survival/Data/R.Data/Survival_Adults_allGroups.RData")
