...
fitsocial.toppartner<-coxme(Surv(Age_entry.days, Age_event.days, Survival)~top.partner*sex+ percentrank+ (1|year.prehurr)+(1|id),data=data) #Runs a cox PH model with age as the time scale.
