#proximity_survival_preTimeVarying_allgroups.R
...
save(strength.prox.pre, degree.prox.pre, file = "ProxMdlOutput_PreHurr_allgroups.RData")
# setwd("~/Documents/GitHub/Cayo-Maria-Survival/Data/R.Data/")
# load("ProxMdlOutput_PreHurr_allgroups.RData")
