#proximity_survival_postTimeVarying_PM.R
...
degree.prox.post.PM <- with(imp, coxme(Surv(Age_entry.days, Age_event.days, Survival)~ 
...
strength.prox.post.PM <- with(imp, coxme(Surv(Age_entry.days, Age_event.days, Survival)~ 
...
save(strength.prox.post.PM, degree.prox.post.PM, file = "ProxMdlOutput_PostHurr_PM.RData")
# setwd("~/Documents/GitHub/Cayo-Maria-Survival/Data/R.Data/")
# load("ProxMdlOutput_PostHurr_PM.RData")
