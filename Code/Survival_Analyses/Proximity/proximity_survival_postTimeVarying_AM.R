...
degree.prox.post.AM <- with(imp, coxme(Surv(Age_entry.days, Age_event.days, Survival)~ 
...
strength.prox.post.AM <- with(imp, coxme(Surv(Age_entry.days, Age_event.days, Survival)~ 
...
save(strength.prox.post.AM, degree.prox.post.AM, file = "ProxMdlOutput_PostHurr_AM.RData")
# setwd("~/Documents/GitHub/Cayo-Maria-Survival/Data/R.Data/")
# load("ProxMdlOutput_PostHurr_AM.RData")
